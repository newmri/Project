...
namespace UNIT {
	enum STATE_ID { ATTACK, BUILD, IDLE, DIE, WALK, STATE_END};
...
enum IMAGE_ID { MAIN_MENU_IMAGE, BOTTOM_MENU_IMAGE, MAIN_MAP_IMAGE,
				...
				UNIT_SELECT_IMAGE,UNIT_SUMMON_QUEUE, PROGRESS, BARRACK_BUILD, BARRACK_BUILD_ICON, CONTROLS_BUILD_ICON, SCV_COMMAND_ICON, SCV_BASIC_BUILD_ICON, BUILD_IMAGE, MINE_IMAGE, IMAGE_END };
