...
enum OBJ_ID { BARRACK, CONTROL, GHOST, MARINE, SCV, CURSOR, OBJ_END, STAGE };
enum STRUCTURE_STATE_ID {STRUCTURE_FLY, STRUCTURE_IDLE,
						 STRUCTURE_PRODUCE_UNIT, STRUCTURE_STATE_END};



namespace UNIT {
	enum STATE_ID { ATTACK, DIE, IDLE, MOVE, STATE_END};
	enum WIRE_ID {LARGE, SMALL};
	namespace LARGE_WIRE {
	enum LARGE_WIRE_ID { BARRACK, CONTROL, GHOST, MARINE, SCV, MINE, LARGE_WIRE_END };
	};

	namespace SMALL_WIRE {
		enum SMALL_WIRE_ID { GHOST, MARINE, SCV, SMALL_WIRE_END };
	}

};

namespace SCV_STATE {
	enum ID { ATTACK, BUILD, IDLE, MINE, STATE_END };

};

namespace PORTRAIT {
	enum ID { ADVISOR, GHOST, MARINE, SCV, PORTRAIT_END };
};
...
enum CURSOR_ID {ARROW, DRAG, HIGHSCROLL, ILLEGAL, LOWSCROLL, MAGG, MAGR, MAGY, TARGG,TARGY, CURSOR_END };
...
enum TILE_ID { MOVABLE, UNMOVABLE, CLICKABLE, TILE_END };

enum IMAGE_ID { MAIN_MENU_IMAGE, BOTTOM_MENU_IMAGE, MAIN_MAP_IMAGE,
				MINI_MAP_FRAME_IMAGE, TILE_IMAGE, RESOURCES_ICON_IMAGE,
				UNIT_SELECT_IMAGE,UNIT_SUMMON_QUEUE, PROGRESS, BARRACK_BUILD, CONTROL_BUILD,
	BARRACK_BUILD_ICON, CONTROLS_BUILD_ICON, GHOST_COMMAND_ICON, MARINE_COMMAND_ICON, SCV_COMMAND_ICON, SCV_BASIC_BUILD_ICON, SCV_ADVANCED_BUILD_ICON,
	BUILD_IMAGE, GHOST_EFFECT, MARINE_EFFECT, GHOST_SKILL, FIRE1, FIRE2, MINE_IMAGE, IMAGE_END };
...
enum FIRE { FIRE_ONE, FIRE_TWO, FIRE_END };
...
enum SCV_COMMAND { BASIC_BUILD, ADVANCED_BUILD, BASIC};
...
enum ANGLEDIR {TOP = 90, LEFT = 180, BOTTOM = 269, RIGHT = 360};
