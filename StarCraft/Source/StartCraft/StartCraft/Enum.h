...
enum IMAGE_ID { MAIN_MENU_IMAGE, BOTTOM_MENU_IMAGE, MAIN_MAP_IMAGE,
	...
	BARRACK_BUILD_ICON, CONTROLS_BUILD_ICON, MARINE_COMMAND_ICON, SCV_COMMAND_ICON, SCV_BASIC_BUILD_ICON,
	BUILD_IMAGE, GHOST_EFFECT, MARINE_EFFECT, MINE_IMAGE, IMAGE_END };
