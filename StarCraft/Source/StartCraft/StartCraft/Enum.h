...
enum OBJ_ID { BARRACK, CONTROL, MARINE, SCV, CURSOR, OBJ_END, STAGE };
...
namespace UNIT {
	...
	enum LARGE_WIRE_ID { BARRACK, CONTROL, MARINE, SCV, MINE, LARGE_WIRE_END };
	};

	namespace SMALL_WIRE {
		enum SMALL_WIRE_ID { MARINE, SCV, SMALL_WIRE_END };
	}
...
namespace PORTRAIT {
	enum ID { ADVISOR, MARINE, SCV, PORTRAIT_END };
};
...
enum IMAGE_ID { MAIN_MENU_IMAGE, BOTTOM_MENU_IMAGE, MAIN_MAP_IMAGE,
				...
				UNIT_SELECT_IMAGE,UNIT_SUMMON_QUEUE, PROGRESS, BARRACK_BUILD, CONTROL_BUILD, BARRACK_BUILD_ICON, CONTROLS_BUILD_ICON, SCV_COMMAND_ICON, SCV_BASIC_BUILD_ICON, BUILD_IMAGE, MINE_IMAGE, IMAGE_END };
